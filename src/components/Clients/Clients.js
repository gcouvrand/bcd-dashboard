                          ...
                          <div>
                            ...
                            {orders.map((order, index) => (
                                ...
                                >
                                  ...
                                  <p>
                                    <strong>Frais de livraison :</strong> {order.deliveryFee}€
                                  </p>
                                  <p>
                          ...
                          <div>
                            ...
                            {ramonages.map((ramonage, index) => (
                                ...
                                >
                                  ...
                                  <p>
                                    <strong>Frais de livraison :</strong> {ramonage.deliveryFee}€
                                  </p>
                                  <p>
                                    <strong>Remise :</strong> {ramonage.ramonageDiscount}€
                                  </p>
                                  <p>
                                    <strong>Total du panier :</strong> {ramonage.cartTotal}€
                                  </p>
                                  <p>
                                    <strong>Date de livraison :</strong>{" "}
                      ...
                      {completedDeliveries.length > 0 && (
                          <div>
                            ...
                            {completedDeliveries.map((delivery, index) => (
                                ...
                                >
                                  <p>
                                    <strong>Numéro de facture :</strong> {delivery.invoiceNumber}
                                  </p>
                                  <p>
                                    <strong>Date :</strong>{" "}
                      ...
                      {completedSweepings.length > 0 && (
                          <div>
                            ...
                            {completedSweepings.map((sweeping, index) => (
                                ...
                                >
                                  <p>
                                    <strong>Numéro de facture :</strong> {sweeping.invoiceNumber}
                                  </p>
                                  <p>
                                    <strong>Date :</strong> {formatDate(sweeping.date || sweeping.createdAt)}
                                  </p>
                                  <button
                                      onClick={() =>
                      ...
                      {completedSales.length > 0 && (
                          <div>
                            ...
                            {completedSales.map((sale, index) => (
                                ...
                                >
                                  <p>
                                    <strong>Numéro de facture :</strong> {sale.invoiceNumber}
                                  </p>
                                  <p>
